...
// toder api key use kris nahole cholbe na url form e 


let Api_url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyDvNRFmRVdPtvbtlDYXTeBA04XAk_A99uk'
...
function takeCommand(message) {
  if (message.includes("open") && message.includes("chat")) {
    ...
    speak("i am virtual assistant ,made by team code alchemists")
